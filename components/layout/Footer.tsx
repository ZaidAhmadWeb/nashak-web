        ...
        <div className="lg:col-span-1">
          ...
          {!!global?.socialLinks?.length && (
            <div className="flex gap-4 mt-5">
              {global.socialLinks.map((s, i) => (
                <a key={i} href={s.url} target="_blank" rel="noopener noreferrer" className="hover:text-(--accent) transition-colors" aria-label={s.platform}>
